-- Fluxo Operacional por empresa: quem faz cada função (planejamento, copy,
-- postagem feed, postagem story) numa empresa. Múltiplas pessoas por função
-- e uma pessoa pode ter mais de uma função — por isso não é unique em
-- (company_id, role_key), e sim em (company_id, role_key, user_id).
